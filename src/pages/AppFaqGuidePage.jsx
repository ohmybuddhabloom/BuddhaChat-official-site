...
const FEATURES = [
  ...
  ['佛', 'AI 佛祖对话', '随时倾诉、选择不同佛菩萨角色、连续追问，并把启发变成下一步具体练习。'],
...
const FAQS = [
  ['这个 APP 是干什么的？', 'BuddhaChat 是一站式佛教修学 APP：修行、AI 佛祖对话、法师开示、读经和道场交流，都在一个 APP 里。'],
  ['这个 APP 收费吗？', '现阶段免费，下载安装后直接用就可以。'],
  ['一定要注册账号吗？', '可以先用游客方式快速体验；登录后还能长期保存功课、修行记录和社群关系。'],
  ['iPhone 怎么下载？', '扫描海报二维码，点击“App Store 下载”即可，不需要自己在商店里搜索。'],
  ['Android 怎么下载？', '同一个二维码会显示 Google Play 和官方安卓安装包，不需要另外寻找地址。'],
  ['怎么确认是官方 APP？', '二维码固定进入 BuddhaChat 官方页面，下载入口变化后也不用重新寻找。'],
  ['APP 主要有哪些功能？', '每日修行、AI 佛祖对话、法师专属内容、道场社区、经书视频佛乐和个人修行档案。'],
  ['AI 佛祖对话有什么亮点？', '可以随时倾诉、选择不同佛菩萨角色、连续追问，还能把启发连接到具体修行。'],
  ['怎么找到源慧法师？', '在首页点击“源慧法师”专题入口，一键进入，不用搜索姓名或翻找视频。'],
  ['源慧专区里有什么？', '法师介绍、历年开示视频、文章、后续专属课程和禅修活动，集中持续更新。'],
]
